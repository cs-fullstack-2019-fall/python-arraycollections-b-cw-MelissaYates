...
for x in arrayOfNumbers:
    reverseArray = arrayOfNumbers[::-1] # !! : you know how to do this using things that we already used in class
    print(reverseArray) # !! : youre printing this for every iteration 
...
def numArray():
    ...
    for x in arrayNums: 
        if userInput < x:
            print(x) # !! : this does not tell me how many numbers are higher, lower, or equal to
        elif userInput > x:
            print(x) # !! : this does not tell me how many numbers are higher, lower, or equal to
        elif userInput == x:
            print("Equal to number in array") # !! : this does not tell me how many numbers are higher, lower, or equal to
